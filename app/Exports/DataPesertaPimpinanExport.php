...
class DataPesertaPimpinanExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithTitle, ShouldAutoSize
{
    protected $status;
    protected $direktorat;
    protected $search;

    public function __construct($status = 'diterima', $direktorat = null, $search = null)
    {
        $this->status = $status;
    ...
    public function map($pendaftaran): array
    {
        ...
        $totalLaporan = $pendaftaran->laporan()->count();
