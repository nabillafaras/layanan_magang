    ...
    public function index()
{
    try {
        ...
        // 1. Total Peserta Magang yang Diterima (hanya dari Sekretariat Jenderal)
        $totalPeserta = Pendaftaran::where('status', 'diterima')
            ->where('direktorat', 'Sekretariat Jenderal')
            ->count();

        // 2. Total Absensi Hari Ini untuk Peserta Diterima dari Sekretariat Jenderal
        ...
        // 3. Total Laporan untuk Peserta Diterima dari Sekretariat Jenderal
        ...
        // Ambil aktivitas terbaru (hanya dari Sekretariat Jenderal)
        $recentActivities = $this->getRecentActivities();
            
        return view('admin1.admin1', compact(
            'totalPeserta',
            'totalAbsensiHariIni', 
            'totalLaporan',
            'totalAdmin',
...
{
    // Gabungkan aktivitas dari absensi dan laporan (hanya dari Sekretariat Jenderal)
    $absensiActivities = Attendance::select(
        ...
        ->where('pendaftaran.direktorat', 'Sekretariat Jenderal')
