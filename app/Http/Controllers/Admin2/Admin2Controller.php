    ...
    public function index()
{
    try {
        ...
        // 1. Total Peserta Magang yang Diterima (hanya dari Direktorat Jenderal Perlindungan dan Jaminan Sosial)
        $totalPeserta = Pendaftaran::where('status', 'diterima')
            ->where('direktorat', 'Direktorat Jenderal Perlindungan dan Jaminan Sosial')
            ->count();

        // 2. Total Absensi Hari Ini untuk Peserta Diterima dari Direktorat Jenderal Perlindungan dan Jaminan Sosial
        ...
        // 3. Total Laporan untuk Peserta Diterima dari Direktorat Jenderal Perlindungan dan Jaminan Sosial
        ...
        // Ambil aktivitas terbaru (hanya dari Direktorat Jenderal Perlindungan dan Jaminan Sosial)
        $recentActivities = $this->getRecentActivities();
            
        return view('admin2.admin2', compact(
            'totalPeserta',
            'totalAbsensiHariIni', 
            'totalLaporan',
            'totalAdmin',
...
{
    // Gabungkan aktivitas dari absensi dan laporan (hanya dari Direktorat Jenderal Perlindungan dan Jaminan Sosial)
    $absensiActivities = Attendance::select(
        ...
        ->where('pendaftaran.direktorat', 'Direktorat Jenderal Perlindungan dan Jaminan Sosial')
