    ...
    public function mapDirektorat($direktorat)
{
    ...
    // Contoh:
    return view('admin2.direktorat.map', compact('direktorat'));
}
    ...
    public function direktorat2()
    {
        ...
        return view('admin2.direktorat2', compact('jumlahPeserta', 'absensi', 'laporan'));
    }
        ...
        public function detailLaporan($id)
    {
        ...
        return view('admin2.detail_laporan2', compact('laporan'));
    }
    ...
    public function showDirektorat($id)
    {
        ...
        return redirect()->route('admin2.dashboard')->with('error', 'Direktorat tidak ditemukan');
    }
