...
class Pengumuman2Controller extends Controller
{
    ...
    /**
     * Menampilkan daftar pengumuman khusus untuk Direktorat Jenderal Perlindungan dan Jaminan Sosial
     */
    public function index()
    {
        $pengumuman = Pengumuman::with('admin')
                    ->where('kategori', 'Direktorat Jenderal Perlindungan dan Jaminan Sosial')
                    ->orderBy('created_at', 'desc')
                    ->paginate(10);
        
        return view('admin2.pengumuman2', compact('pengumuman'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $pengumuman->kategori = "Direktorat Jenderal Perlindungan dan Jaminan Sosial"; // Set nilai kategori secara langsung
        ...
        return redirect()->route('admin2.pengumuman2.index')
    ...
    public function update(Request $request, $id)
    {
        ...
        // Pastikan hanya pengumuman dengan kategori Direktorat Jenderal Perlindungan dan Jaminan Sosial yang diupdate
        if ($pengumuman->kategori !== 'Direktorat Jenderal Perlindungan dan Jaminan Sosial') {
            return redirect()->route('admin2.pengumuman2.index')
                ->with('error', 'Anda hanya dapat mengedit pengumuman untuk Direktorat Jenderal Perlindungan dan Jaminan Sosial!');
        }
        ...
        $pengumuman->title = $request->title;
        $pengumuman->isi = $request->isi;
        $pengumuman->kategori = "Direktorat Jenderal Perlindungan dan Jaminan Sosial"; // Memastikan kategori tetap Direktorat Jenderal Perlindungan dan Jaminan Sosial
    ...
    public function destroy($id)
    {
        ...
        // Pastikan hanya pengumuman dengan kategori Direktorat Jenderal Perlindungan dan Jaminan Sosial yang dapat dihapus
        if ($pengumuman->kategori !== 'Direktorat Jenderal Perlindungan dan Jaminan Sosial') {
            return redirect()->route('admin2.pengumuman2.index')
                ->with('error', 'Anda hanya dapat menghapus pengumuman untuk Direktorat Jenderal Perlindungan dan Jaminan Sosial!');
        }
    ...
    public function updateStatus($id)
    {
        ...
        // Pastikan hanya pengumuman dengan kategori Direktorat Jenderal Perlindungan dan Jaminan Sosial yang dapat diubah statusnya
        if ($pengumuman->kategori !== 'Direktorat Jenderal Perlindungan dan Jaminan Sosial') {
            return redirect()->route('admin2.pengumuman2.index')
                ->with('error', 'Anda hanya dapat mengubah status pengumuman untuk Direktorat Jenderal Perlindungan dan Jaminan Sosial!');
        }
