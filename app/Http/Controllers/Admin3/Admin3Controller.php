    ...
    public function index()
{
    try {
        ...
        // 1. Total Peserta Magang yang Diterima (hanya dari Direktorat Jenderal Rehabilitasi Sosial)
        $totalPeserta = Pendaftaran::where('status', 'diterima')
            ->where('direktorat', 'Direktorat Jenderal Rehabilitasi Sosial')
            ->count();

        // 2. Total Absensi Hari Ini untuk Peserta Diterima dari Direktorat Jenderal Rehabilitasi Sosial
        ...
        // 3. Total Laporan untuk Peserta Diterima dari Direktorat Jenderal Rehabilitasi Sosial
        ...
        // Ambil aktivitas terbaru (hanya dari Direktorat Jenderal Rehabilitasi Sosial)
        $recentActivities = $this->getRecentActivities();
            
        return view('admin3.admin3', compact(
            'totalPeserta',
            'totalAbsensiHariIni', 
            'totalLaporan',
            'totalAdmin',
...
{
    // Gabungkan aktivitas dari absensi dan laporan (hanya dari Direktorat Jenderal Rehabilitasi Sosial)
    $absensiActivities = Attendance::select(
        ...
        ->where('pendaftaran.direktorat', 'Direktorat Jenderal Rehabilitasi Sosial')
