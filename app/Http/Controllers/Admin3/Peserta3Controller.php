...
class Peserta3Controller extends Controller
{
    ...
    public function index(Request $request)
{
    ...
    // Filter tetap hanya menampilkan direktorat Direktorat Jenderal Rehabilitasi Sosial
    ...
    return view('admin3.peserta3', compact('pendaftaran', 'unit_kerja', 'status'));
}
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin3.peserta3')->with('success', 'Status peserta berhasil diperbarui');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin3.peserta3.show', compact(
            'peserta', 
            'totalAbsensi', 
            'hadir', 
            'izin', 
    ...
    public function exportExcel(Request $request)
{
    ...
    $direktorat = $request->direktorat ?? 'Direktorat Jenderal Rehabilitasi Sosial'; // Default jika tidak ada
