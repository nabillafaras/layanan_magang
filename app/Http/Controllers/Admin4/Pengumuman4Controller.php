...
class Pengumuman4Controller extends Controller
{
    ...
    /**
     * Menampilkan daftar pengumuman khusus untuk Direktorat Jenderal Pemberdayaan Sosial
     */
    public function index()
    {
        $pengumuman = Pengumuman::with('admin')
                    ->where('kategori', 'Direktorat Jenderal Pemberdayaan Sosial')
                    ->orderBy('created_at', 'desc')
                    ->paginate(10);
        
        return view('admin4.pengumuman4', compact('pengumuman'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $pengumuman->kategori = "Direktorat Jenderal Pemberdayaan Sosial"; // Set nilai kategori secara langsung
        ...
        return redirect()->route('admin4.pengumuman4.index')
    ...
    public function update(Request $request, $id)
    {
        ...
        // Pastikan hanya pengumuman dengan kategori Direktorat Jenderal Pemberdayaan Sosial yang diupdate
        if ($pengumuman->kategori !== 'Direktorat Jenderal Pemberdayaan Sosial') {
            return redirect()->route('admin4.pengumuman4.index')
                ->with('error', 'Anda hanya dapat mengedit pengumuman untuk Direktorat Jenderal Pemberdayaan Sosial!');
        }
        ...
        $pengumuman->title = $request->title;
        $pengumuman->isi = $request->isi;
        $pengumuman->kategori = "Direktorat Jenderal Pemberdayaan Sosial"; // Memastikan kategori tetap Direktorat Jenderal Pemberdayaan Sosial
    ...
    public function destroy($id)
    {
        ...
        // Pastikan hanya pengumuman dengan kategori Direktorat Jenderal Pemberdayaan Sosial yang dapat dihapus
        if ($pengumuman->kategori !== 'Direktorat Jenderal Pemberdayaan Sosial') {
            return redirect()->route('admin4.pengumuman4.index')
                ->with('error', 'Anda hanya dapat menghapus pengumuman untuk Direktorat Jenderal Pemberdayaan Sosial!');
        }
    ...
    public function updateStatus($id)
    {
        ...
        // Pastikan hanya pengumuman dengan kategori Direktorat Jenderal Pemberdayaan Sosial yang dapat diubah statusnya
        if ($pengumuman->kategori !== 'Direktorat Jenderal Pemberdayaan Sosial') {
            return redirect()->route('admin4.pengumuman4.index')
                ->with('error', 'Anda hanya dapat mengubah status pengumuman untuk Direktorat Jenderal Pemberdayaan Sosial!');
        }
