    ...
    public function index(Request $request)
{
    ...
    // Filter tetap hanya menampilkan direktorat Direktorat Jenderal Pemberdayaan Sosial
    ...
    return view('admin4.peserta4', compact('pendaftaran', 'unit_kerja', 'status'));
}
    ...
    public function show($id)
    {
        ...
        return view('admin4.peserta4.show', compact(
            'peserta', 
            'totalAbsensi', 
            'hadir', 
            'izin', 
    ...
    public function exportExcel(Request $request)
{
    ...
    $direktorat = $request->direktorat ?? 'Direktorat Jenderal Pemberdayaan Sosial'; // Default jika tidak ada
