    ...
    public function index()
{
    try {
        ...
        // 1. Total Peserta Magang yang Diterima (hanya dari Inspektorat Jenderal)
        $totalPeserta = Pendaftaran::where('status', 'diterima')
            ->where('direktorat', 'Inspektorat Jenderal')
            ->count();

        // 2. Total Absensi Hari Ini untuk Peserta Diterima dari Inspektorat Jenderal
        ...
        // 3. Total Laporan untuk Peserta Diterima dari Inspektorat Jenderal
        ...
        // Ambil aktivitas terbaru (hanya dari Inspektorat Jenderal)
        $recentActivities = $this->getRecentActivities();
            
        return view('admin5.admin5', compact(
            'totalPeserta',
            'totalAbsensiHariIni', 
            'totalLaporan',
            'totalAdmin',
