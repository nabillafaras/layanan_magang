    ...
    public function mapDirektorat($direktorat)
{
    ...
    // Contoh:
    return view('admin5.direktorat.map', compact('direktorat'));
}

    public function direktorat5()
    {
        // Hitung jumlah peserta magang aktif di Direktorat 5
        ...
        return view('admin5.direktorat5', compact('jumlahPeserta', 'absensi', 'laporan'));
    }
        ...
        public function detailLaporan($id)
    {
        ...
        return view('admin5.detail_laporan5', compact('laporan'));
    }
    ...
    public function showDirektorat($id)
    {
        ...
        return redirect()->route('admin5.dashboard')->with('error', 'Direktorat tidak ditemukan');
    }
