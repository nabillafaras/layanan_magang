...
class Peserta5Controller extends Controller
{
    ...
    public function index(Request $request)
{
    ...
    // Filter tetap hanya menampilkan direktorat Inspektorat Jenderal
    ...
    return view('admin5.peserta5', compact('pendaftaran', 'unit_kerja', 'status'));
}
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin5.peserta5')->with('success', 'Status peserta berhasil diperbarui');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin5.peserta5.show', compact(
            'peserta', 
            'totalAbsensi', 
            'hadir', 
            'izin', 
    ...
    public function exportExcel(Request $request)
{
    ...
    $direktorat = $request->direktorat ?? 'Inspektorat Jenderal'; // Default jika tidak ada
