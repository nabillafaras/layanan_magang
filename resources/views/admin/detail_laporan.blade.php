...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <a href="{{ asset('storage/'.$laporan->file_path) }}" class="btn btn-primary" target="_blank">
            ...
            @if($laporan->jenis_laporan == 'akhir' && $laporan->status == 'Acc')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-9">
                        <a href="{{ asset($laporan->sk_selesai) }}" class="btn btn-success" target="_blank">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-9">
                        <a href="{{ asset($laporan->nilai_magang) }}" class="btn btn-success" target="_blank">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.update-status', ['id' => $laporan->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.submit-feedback', ['id' => $laporan->id]) }}" method="POST">
                @csrf
                <div class="mb-3">
