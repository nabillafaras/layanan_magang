...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        ...
        @endif
        <li class="breadcrumb-item active">Detail Laporan Sekretariat Jenderal</li>
    </ol>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin1.update-status', ['id' => $laporan->id]) }}" method="POST">
                @csrf
                <div class="mb-3">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin1.submit-feedback', ['id' => $laporan->id]) }}" method="POST">
                @csrf
                <div class="mb-3">
