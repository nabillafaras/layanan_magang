...
<div class="container-fluid px-4">
    <div class="dashboard-header fade-in">
        ...
        <ol class="breadcrumb mb-4 slide-in-right">
            ...
            <li class="breadcrumb-item active">Peserta Pendaftar Sekretariat Jenderal</li>
        </ol>
    </div>
    ...
    <div class="card filter-card mb-4 slide-in-up" style="animation-delay: 0.1s">
        ...
        <div class="card-body">
            <form action="{{ route('admin1.peserta1') }}" method="GET">
                <div class="row">
    ...
    <div class="card bounce-in" style="animation-delay: 0.2s">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="col-md-2 mb-2 d-flex align-items-end">
                    <a href="{{ route('admin1.export-datapeserta1') }}?bulan={{ request('bulan', date('Y-m')) }}&direktorat={{ request('direktorat', '') }}" class="btn btn-success w-100">
...
<div class="modal fade" id="updateModal{{ $p->id }}" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('admin1.peserta1.update', $p->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
