...
<div class="container-fluid px-4">
    <div class="dashboard-header fade-in">
        ...
        <ol class="breadcrumb mb-4 slide-in-right">
            ...
            <li class="breadcrumb-item active">Peserta Pendaftar Direktorat Jenderal Rehabilitasi Sosial</li>
        </ol>
    </div>
...
<div class="card filter-card mb-4 slide-in-up" style="animation-delay: 0.1s">
    ...
    <div class="card-body">
        <form action="{{ route('admin3.peserta3') }}" method="GET">
            <div class="row">
                ...
                <div class="col-md-3 mb-2">
                    <label for="direktorat" class="form-label">Unit Kerja</label>
    ...
    <div class="card bounce-in" style="animation-delay: 0.2s">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="col-md-2 mb-2 d-flex align-items-end">
                    <a href="{{ route('admin3.export-datapeserta3') }}?bulan={{ request('bulan', date('Y-m')) }}&direktorat={{ request('direktorat', '') }}" class="btn btn-success w-100">
...
<div class="modal fade" id="updateModal{{ $p->id }}" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('admin3.peserta3.update', $p->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
