...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        @if(session('previous_direktorat'))
            <li class="breadcrumb-item"><a href="{{ route('admin4.direktorat', ['id' => session('previous_direktorat')]) }}">Direktorat {{ session('previous_direktorat') }}</a></li>
        @endif
        <li class="breadcrumb-item active">Detail Laporan Direktorat Jenderal Pemberdayaan Sosial</li>
    </ol>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin4.update-status', ['id' => $laporan->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin4.submit-feedback', ['id' => $laporan->id]) }}" method="POST">
                @csrf
                <div class="mb-3">
