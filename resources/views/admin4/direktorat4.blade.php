...
@section('title', 'Direktorat Jenderal Pemberdayaan Sosial - Kementerian Sosial RI')
...
<style>
    ...
    @media (max-width: 992px) {
        .table-responsive table {
            min-width: 1200px; /* Sesuaikan dengan jumlah dan lebar kolom */
        }
    }
    
    /* Tambahkan efek shadow saat di-scroll untuk UX yang lebih baik */
...
<div class="container-fluid px-4">
    <div class="dashboard-header fade-in">
        <h2 class="mt-4">Direktorat Jenderal Pemberdayaan Sosial</h2>
        <ol class="breadcrumb mb-4 slide-in-right">
            <li class="breadcrumb-item"><a href="{{ route('admin4.dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item active">Direktorat Jenderal Pemberdayaan Sosial</li>
        </ol>
    </div>
                                    ...
                                    <tr class="fade-in" style="animation-delay: {{ $index * 0.05 }}s">
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="{{ route('admin4.detail-laporan4', ['id' => $l->id]) }}" class="btn btn-sm btn-primary">
