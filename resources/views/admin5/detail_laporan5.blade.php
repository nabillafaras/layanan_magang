...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        @if(session('previous_direktorat'))
            <li class="breadcrumb-item"><a href="{{ route('admin5.direktorat', ['id' => session('previous_direktorat')]) }}">Direktorat {{ session('previous_direktorat') }}</a></li>
        @endif
        <li class="breadcrumb-item active">Detail Laporan Inspektorat Jenderal</li>
    </ol>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin5.update-status', ['id' => $laporan->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin5.submit-feedback', ['id' => $laporan->id]) }}" method="POST">
                @csrf
                <div class="mb-3">
