    ...
    <div class="wrapper" id="app">
        ...
        <div class="sidebar slide-in-left">
            ...
            <div class="user-profile">
                <a href="{{ route('admin1.profile.index') }}" class="profile-link">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                <a href="{{ route('admin1.peserta1') }}" class="nav-link {{ request()->routeIs('admin1.peserta1') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin1.direktorat1') ? 'active' : '' }}" href="{{ route('admin1.direktorat1')}}">
                        <i class="fas fa-building"></i> Sekretariat Jenderal
                    </a>
                </li>
                <li class="nav-item">
