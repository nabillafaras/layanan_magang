    ...
    <div class="wrapper" id="app">
        ...
        <div class="sidebar slide-in-left">
            ...
            <div class="user-profile">
                <a href="{{ route('admin2.profile.index') }}" class="profile-link">
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                <a href="{{ route('admin2.dashboard') }}" class="nav-link {{ request()->routeIs('admin2.dashboard') ? 'active' : '' }}">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end animate__animated animate__fadeIn" aria-labelledby="userDropdown">
                                    <li>
                                        <a href="{{ route('admin2.profile.index') }}" class="dropdown-item">
