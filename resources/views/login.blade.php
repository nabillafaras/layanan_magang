    ...
    <div class="main-container">
        ...
        <div class="right-section">
            <div class="login-form-container">
                ...
                <form action="{{ route('login.authenticate') }}" method="POST" data-aos="fade-up" data-aos-delay="100">
                    @csrf
                    <div class="form-group">
                        <label for="nomor_pendaftaran">Nomor Pendaftaran</label>
                        <input type="text" id="nomor_pendaftaran" name="nomor_pendaftaran" class="form-control" placeholder="Masukkan Nomor Pendaftaran" required>
                    </div>
                ...
                <div class="footer-links" data-aos="fade-up" data-aos-delay="200">
                    <p>Admin? <a href="{{ route('admin.login') }}">Login Disini</a></p>
