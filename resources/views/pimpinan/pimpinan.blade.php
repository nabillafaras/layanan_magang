...
<div class="container-fluid px-4">
    ...
    <div class="row">
        <div class="col-lg-3 col-6 mb-4">
            <div class="stat-card slide-in-up" style="animation-delay: 0.1s">
                ...
                <div class="progress">
                    <div class="progress-bar bg-primary progress-animate" role="progressbar" style="--progress-width: 75%;"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-6 mb-4">
            <div class="stat-card slide-in-up" style="animation-delay: 0.2s">
                ...
                <div class="progress">
                    <div class="progress-bar bg-success progress-animate" role="progressbar" style="--progress-width: 60%;"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-6 mb-4">
            <div class="stat-card slide-in-up" style="animation-delay: 0.3s">
                ...
                <div class="progress">
                    <div class="progress-bar bg-warning progress-animate" role="progressbar" style="--progress-width: 45%;"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-6 mb-4">
            <div class="stat-card slide-in-up" style="animation-delay: 0.4s">
                ...
                <div class="progress">
                    <div class="progress-bar bg-danger progress-animate" role="progressbar" style="--progress-width: 90%;"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <!-- Distribusi Peserta per Direktorat -->
