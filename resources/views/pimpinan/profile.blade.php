    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="dashboard-card animate__animated animate__fadeInLeft">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('pimpinan.profile.update') }}" method="POST" id="profileForm">
                        @csrf
                        @method('PUT')
        ...
        <div class="col-md-6">
            <div class="dashboard-card animate__animated animate__fadeInRight">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('pimpinan.profile.update-password') }}" method="POST" id="changePasswordForm">
                        @csrf
                        @method('PUT')
